//
//  TextTableSectionHeaderView.swift
//  Sample
//
...
class TextTableSectionHeaderView: UIView {
...
extension TextTableSectionHeaderView: P9TableViewCellProtocol {
    
    static func cellHeightForData(_ data: Any?, extra: Any?) -> CGFloat {
        
        guard let data = data as? [String:Any], let type = data["type"] as? Int, (type == 1 || type == 2) else {
            return 0
        }
